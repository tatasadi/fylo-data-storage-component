  ...
  return (
    <main className="flex h-full min-h-screen w-full max-w-7xl flex-col items-center px-4 pt-20 lg:min-h-0 lg:pt-32">
      ...
      <div className="flex flex-col gap-4 lg:flex-row">
        <div className="rounded-[0.625rem] rounded-tr-[6.25rem] bg-neutral-dark-blue p-10 shadow-[0_75px_100px_-30px_rgba(0,0,0,0.25)]">
        ...
        <div className="relative flex flex-col items-center rounded-[0.625rem] bg-neutral-dark-blue p-8 shadow-[0_75px_100px_-30px_rgba(0,0,0,0.25)]">
          ...
          <p className="absolute -bottom-10 flex items-center rounded-[0.625rem] bg-white px-6 py-4 text-[2.5rem] font-bold leading-10 text-neutral-very-dark-blue">
            <span>185</span>
